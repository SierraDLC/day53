...
public class BankAccountMain {
    ...
    public static void main(String[] args) {
        ...
        BankAccount Lapo = new BankAccount("Larry", 10001, 5000);
        
        Lapo.withdraw(100);
        
        BankAccount Wapo = new BankAccount("Wapo", 10002, 300);
        ...
        System.out.println("Welcome to GuapFarm Banking!");
    ...
    public static void mainMenu(BankAccount account){
        ...
        while(response != 0){
            if(response == 1){
                ...
                int accountToTransferTo = Integer.parseInt(scanner.nextLine());
